          ...
          <Stack direction="column" spacing={10} justifyContent="center">
            ...
            >
              ...
              <chakra.span
                fontWeight="500"
                fontSize="6xl"
                bgGradient="linear(to-br, #afd485, #15aabf)"
                bgClip="text"
                lineHeight={1.5}
              >
                Calori Sync
            ...
            <Text
              ...
              maxW="700px"
            >
              CaloriSync는 실제로 소비한 칼로리와 섭취한 칼로리 간의 불균형을
              추적하고 관리할 수 있는 스마트 헬스 앱입니다. <br />
              개인의 식습관과 활동 데이터를 기반으로 체계적인 칼로리 균형을
              제안하여 더 건강한 삶을 지원합니다. <br />
              목표를 설정하고, 매일의 섭취와 소비를 비교하며 균형 잡힌
              라이프스타일을 만들어보세요
            </Text>
            ...
            >
              <chakra.button
                ...
                bgGradient="linear(to-br, #afd485, #15aabf)"
                color="white"
                _hover={{ bgGradient: "linear(to-br, #afd485, #15aabf)" }}
                variant="solid"
                size="lg"
                rounded="md"
                fontWeight="bold"
